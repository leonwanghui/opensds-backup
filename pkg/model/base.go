...
func (base *BaseModel) CreatedTime() utils.RFC8601DateTime {
	createdTime, _ := utils.NewDateTime(base.CreatedAt)
	return createdTime
}
...
func (base *BaseModel) UpdatedTime() utils.RFC8601DateTime {
	updatedTime, _ := utils.NewDateTime(base.UpdatedAt)
	return updatedTime
}
